...
function SuccessContent() {
  ...
  const upiLink = `upi://pay?pa=shankarnarayanan4@ybl&pn=${encodeURIComponent("Dr D's MedCare")}&am=${booking?.final_price_inr ?? 0}&cu=INR`
    ...
    <main className="mx-auto max-w-lg px-4 py-16">
      ...
      {booking && (
        <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-5 text-center">
          ...
          <p className="mt-3 text-sm font-semibold text-slate-800">shankarnarayanan4@ybl</p>
